...
{ 
	...
	public function getChoices_p12()
	{
		$choices_p12 = array(
				'choices'  => array(
						...
						'entre un 30% y un 49%' => 'C',
						'50% de sus pacientes' => 'D',
						$this->getNo_aplica() => 'E',
				), 'multiple'=>false,'expanded'=>true
		);
	...
	{
		$email = array(
				'subject-new-password' => utf8_encode('Proyecto Simplicity Cuestionario: Nueva contraseña'),
	...
	{
		$titulos_f1 = array(
				'p1'=>utf8_encode('En su experiencia clínica, valore la influencia de los siguientes factores en la <strong>adherencia al tratamiento</strong> con los actuales AADs. (Siendo: 1.Nada influyente; 2.Poco influyente; 3.Moderadamente influyente; 4. Bastante influyente y 5. Muy influyente):'),
				...
				'p8'=>utf8_encode('El presentismo laboral se define como la pérdida de productividad en el propio trabajo como resultado de una enfermedad, <strong>¿ha mejorado con los actuales AADs en sus pacientes con hepatitis C?</strong>'),
				...
				'p13'=>utf8_encode('Los actuales AADs han <strong>simplificado el diagnóstico y la evaluación de la hepatitis C crónica.</strong> Indique en qué medida son necesarias las siguientes <strong>determinaciones antes del inicio de este tratamiento:</strong> (1 no necesaria, 2 se puede considerar, 3 conveniente, 4 imprescindible)'),
				...
				'p13g'=>utf8_encode('Determinación de las RAVs basales por SMV o en fracaso.'),
				'p13h'=>utf8_encode('Determinación de las RAVs tras fracaso con AADs.'),
				'p13i'=>utf8_encode('Determinación de la función hepática.'),
				'p14'=>utf8_encode('¿Cuántos de sus pacientes en lista de espera han abandonado la <strong>lista de espera de trasplante hepático</strong> tras recibir tratamiento con los actuales AADs?'),
				'p15'=>utf8_encode('¿Cuándo da el <strong>alta</strong> a los pacientes con <strong>fibrosis leve-moderada</strong> tratados con AADs?'),
				'p16'=>utf8_encode('En su experiencia clínica, ¿qué porcentaje de pacientes monoinfectados que alcanzan RVS son <strong>dados de alta definitivamente</strong> de la consulta hospitalaria?'),
				'p17'=>utf8_encode('¿Cuál es el <strong>promedio de consultas</strong> a las que acude un paciente que recibe <strong>12 semanas</strong> con actuales AADs?'),
				...
				'p20'=>utf8_encode('Respecto al <strong>seguimiento</strong> de los pacientes con fibrosis avanzada o cirrosis que han alcanzado RVS tras tratamiento con los actuales AADs. Señale cuál es su práctica habitual:'),
				'p21'=>utf8_encode('Valore el <strong>beneficio de la simplificación</strong> asociada a los actuales tratamientos AADs en los siguientes aspectos: (1 ningún beneficio, 5 máximo beneficio)'),
